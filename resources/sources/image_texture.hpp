...
public:
    static std::optional<ImageTexture> from(std::filesystem::path imagePath, const std::string& uniformName, gl::GLint textureUnitNum)
    {
...
private:
        ...
        , m_imagePath{ imagePath }
    {
        ...
        gl::glTexParameteri(m_target, gl::GL_TEXTURE_WRAP_S, gl::GL_REPEAT);
        gl::glTexParameteri(m_target, gl::GL_TEXTURE_WRAP_T, gl::GL_REPEAT);
