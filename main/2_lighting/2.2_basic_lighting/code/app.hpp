...
public:
    ...
    static inline auto s_assets_path = util::assets_path("2.2_basic_lighting");
...
private:
    ...
    void prepareObject()
    {
        ...
        // normal attrib
        glVertexAttribPointer(1, VertexData{}.normal.size(), GL_FLOAT, GL_FALSE, sizeof(VertexData), (void*)offsetof(VertexData, normal));
