...
private:
    void showMainWindow()
    {
        ...
        ImGui::SliderFloat("outline scale", &m_scene.m_outlineScale, 1.01f, 2.0f);
        ImGui::ColorEdit3("outline color", &m_scene.u_outlineColor.m_value.r);
    ...
    void showOverlayWindow()
    {
...

        {
            ...
            ImGui::Text("cam speed : %.2f", m_scene.m_camera.m_speed);
            ...
            if (m_window.isMouseCaptured()) {
                ImGui::Text("cursor pos: [captured]");
            } else {
                auto cursorPos{ m_window.getProperties().m_cursorPos };
